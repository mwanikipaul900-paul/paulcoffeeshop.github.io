    ...
    try {
        ...
        if (paymentMethod === 'mpesa') {
            ...
            return res.json({
                ...
                paymentUrl: null,
                phone,
                message: 'M-Pesa payment should be triggered from backend STK push flow'
            });
        }
        ...
        const tapPayload = {
            ...
            currency: paymentMethod === 'knet' ? 'KWD' : 'KWD',
            threeDSecure: true,
            save_card: false,
            ...
            customer: {
                ...
                phone: {
                    country_code: customer.phone.startsWith('254') ? '254' : '965',
